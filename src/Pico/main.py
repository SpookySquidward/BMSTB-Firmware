...
class main:
    def __init__(self, adc_read_samples, adc_read_frequency):
        # Pin definitions
        ...
        self.adc_read_samples = adc_read_samples
    ...
    def _read_ADC(self, adc):
        ...
        Timer(-1).init(mode=Timer.PERIODIC, freq=self.adc_read_frequency, callback=timer_callback)
        ...
        return adc_counts / (self.adc_read_samples * 65535)
